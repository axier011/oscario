...
DEFAULT_PINS: list[tuple] = [
    ...
    (29,  5, "GPIO5",             "GPIO_OUTPUT", False, 0),
    (30, -1, "Ground",            "GROUND",      False, 0),
    (31,  6, "GPIO6",             "GPIO_OUTPUT", False, 0),
